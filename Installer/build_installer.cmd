...
makensis _BRAINSIM3.nsi >"%ORGDIR%\Step4BuildInstaller.log"
PAUSE

IF DEFINED CERTFILE (
	ECHO Signing the install.exe. . .
	signtool sign /f %CERTFILE% /p FutureAI /t http://timestamp.comodoca.com "%ORGDIR%\Brain Simulator III Setup.exe" >"%ORGDIR%\Step5SignInstaller.log"
)
...
IF EXIST "%WEBDIR%" (
	...
	copy "Brain Simulator III Setup.exe" %WEBDIR%
