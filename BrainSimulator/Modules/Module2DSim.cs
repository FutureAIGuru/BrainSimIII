...
namespace BrainSimulator.Modules
{
    public class Module2DSim : ModuleBase
    {
        ...
        public double boundarySize = 5;  // Gives a 10x10 space (+/-5)
        ...
        //Training samples are triples... a spoken phrase, an action, and an outcome (separated by colons)
        ...
        {
            ModuleHearWords nmWords = (ModuleHearWords)FindModule(typeof(ModuleHearWords));
            if (nmWords != null)
        ...
        public void SetModel()
        {
            ...
            Initialize();
            Module2DModel nmModel = (Module2DModel)FindModule(typeof(Module2DModel));
