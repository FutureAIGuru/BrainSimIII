...
{
    public class ModulePodAction : ModuleBase
    {
        ...
        public override void Fire()
        {
            ...
            ModuleView modulePodPose = MainWindow.theNeuronArray.FindModuleByLabel("PodPose");
            if (modulePodPose == null) return;
