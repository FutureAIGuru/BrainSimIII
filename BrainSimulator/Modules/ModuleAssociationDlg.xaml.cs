...
namespace BrainSimulator.Modules
{
    public partial class ModuleAssociationDlg : ModuleBaseDlg
    {
        ...
        public override bool Draw(bool checkDrawTimer)
        {
            ...
            if (attn == null || attn.Relationships.Count == 0) return false;

            busy = true;
            Thing attnTarget = attn.GetRelationshipWithAncestor(uks.Labeled("Visual"));
            ...
            words = words.Reverse().ToList(); // Reversing words so new words show first.
            ...
            foreach (Thing property in properties)
            {
                ...
                dr[0] = property.Label;
                List<Relationship> refs = property.GetRelationshipByWithAncestor(uks.Labeled("Word"));
            ...
            foreach (Thing relationship in relationships)
            {
                ...
                List<Relationship> refs = relationship.GetRelationshipByWithAncestor(uks.Labeled("Word"));
                for (int i = 0; i < words.Count; i++)
                {
