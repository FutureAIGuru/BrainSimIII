...
{
    // Module2DModel is an internal model for the entity named "Sallie".
    // Its coordinate system is specified in PointPlus objects which can be adjusted both in orthogonal or polar settings.
    // The coordinate system is centered on Sallie, with +X being her forward movement. In the dialog Sallie is seen from above.
    public class Module2DModel : ModuleBase
    {
        // These two lists contain the Segments and their Points, as imported from the UKSN module that is required.
        ...
        // Constructor only makes two empty lists.
        ...
        public override void Fire()
        {
            ...
            ModuleBehavior nmBehavior = (ModuleBehavior)FindModule(typeof(ModuleBehavior));
        ...
        {
            ModuleUKSN nmUKS = (ModuleUKSN)FindModule(typeof(ModuleUKSN));
        ...
        {
            ModuleUKS nmUKS = (ModuleUKSN)FindModule(typeof(ModuleUKSN));
            if (nmUKS is ModuleUKS UKS)
            {
                Thing t1, t2;
                Thing t3 = null;
        ...
        public Thing AddSegmentFromVision(PointPlus P1, PointPlus P2, ColorInt theColor, bool moved)
        {
            ...
            ModuleUKSN UKS = (ModuleUKSN)FindModule(typeof(ModuleUKSN));
            GetSegmentsFromUKS();
            if (UKS != null)
            {
        ...
        ******************************** */
        ...
        public override void Initialize()
        {
            ...
            ModuleUKSN UKSn = (ModuleUKSN)FindModule(typeof(ModuleUKSN));
            if (UKSn == null) return;
