...
namespace BrainSimulator.Modules
{
    public class ModuleMoveObject : ModuleBase
    {
        ...
        public override void Fire()
        {
            ...
            ModuleBehavior mBehavior = (ModuleBehavior)FindModule(typeof(ModuleBehavior));
            if (mBehavior == null) return;
            Module2DModel mModel = (Module2DModel)FindModule(typeof(Module2DModel));
            if (mModel is null) return;
            ModuleEvent mEvent = (ModuleEvent)FindModule(typeof(ModuleEvent));
            ...
            if (lastPosition == null) //create objects to keep track of the target and last position
            {
                ...
                lastPosition.ChangeParent(UKS.Labeled("Segment"), UKS.Labeled("SSegment"));
                Module2DSim mSim = (Module2DSim)FindModule(typeof(Module2DSim));
